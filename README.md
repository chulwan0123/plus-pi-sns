...
- **산출물**(`exports/`): 가이드별로 아래 세트를 만든다.
  ...
  - **이미지**: 대지별 `…_0N.png`(각 클립 **마지막 프레임** = 최종 애니메이션 상태) + 표지 `…_표지.png`
...
| 05 | 파이 이용가이드 05_세금 없이 물려주기 | `#tab4` | `#guide4` | 7 | guide4-closing.mp4 |
...
tools/
  ...
  export-cover.js              표지 PNG(GUIDE=02|03|05); 대지별 이미지는 클립 마지막 프레임에서 추출
